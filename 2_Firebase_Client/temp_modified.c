...
//   float heatIndex =
//       dht.computeHeatIndex(newValues.temperature, newValues.humidity);
//   float dewPoint =
//       dht.computeDewPoint(newValues.temperature, newValues.humidity);
...
//   Serial.println(" T:" + String(newValues.temperature) + " H:" +
//                  String(newValues.humidity) + " I:" + String(heatIndex) +
//                  " D:" + String(dewPoint) + " " + comfortStatus);
...
//   network->firestoreDataUpdate(newValues.temperature, newValues.humidity);
  network->firestoreDataUpdate(98.1,59.2);
